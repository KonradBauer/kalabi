...
# Build args — needed for Payload CMS to connect to MongoDB during build
ARG DATABASE_URL
ARG PAYLOAD_SECRET
...
RUN mkdir -p ./public/media ./public/videos && chown -R nextjs:nodejs ./public/media ./public/videos
